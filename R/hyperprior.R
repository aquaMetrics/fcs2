...
#'
#' The hyperprior distribution with shape parameter \eqn{a} and scale parameter
#' \eqn{b} has density \deqn{p(x) = 2 \frac{b^a}{\Gamma(a)} \frac{1}{x^{2a +
#' 1}} \exp\left( -\frac{b}{x^2} \right) }{% p(x) = 2 b^a / (\Gamma(a) x^(2a +
#' 1)) exp( -b / (x^2) ) } for \eqn{x, a, b > 0}.
#'
...
#'
#' @aliases hyperprior dhyperprior phyperprior qhyperprior rhyperprior
